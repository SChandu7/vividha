...
const DEMO_PRODUCTS = [
  { id:1, name:'Kanjivaram Pure Silk Saree', category:'Sarees', sub_category:'Silk Sarees', brand:'Kanjivaram Heritage', price:4999, original_price:7499, stock:12, tag:'hot', image:'https://images.unsplash.com/photo-1611811960734-2b1b8b5d17b1?w=600&q=80', description:'Exquisite pure Kanjivaram silk saree with traditional gold zari border. A timeless piece for weddings and celebrations.', fabric:'Pure Silk, Zari', colors:['#8B0000','#1B2A4A','#2D5A1E','#C9A84C'], status:'active' },
  ...
  { id:3, name:'Floral Anarkali Kurti', category:'Kurtis', sub_category:'Anarkali', brand:'Vividha Studio', price:1299, original_price:1799, stock:50, tag:'new', image:'https://images.unsplash.com/photo-1583391733956-6c78276477e2?w=600&q=80', description:'Beautiful floral printed Anarkali kurti with gota patti work. Pairs perfectly with churidar or palazzo.', fabric:'Rayon, Cotton', colors:['#E8789A','#F7F0DC','#4A5E8A'], status:'active' },
